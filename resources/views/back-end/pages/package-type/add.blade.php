        ...
        <div class="row">
            <div class="col-sm-8 col-xs-12">
                <div class="card card-block sameheight-item">
                    ...
                    <form method="post" action="/admin/package-type">
                        {{ csrf_field() }}
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label class="control-label">Name</label>
                            <input type="text" name="name" class="form-control boxed" placeholder="Document">
                        ...
                        <div class="form-group {{ $errors->has('optional_package') ? ' has-error' : '' }}">
                            ...
                            <p>
                                <label class="radio-inline"> <input type="radio" name="optional_package" checked value="1"> Yes</label>
                                <label class="radio-inline"> <input type="radio" name="optional_package" value="0"> No</label>
                            </p>
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <textarea name="description" class="form-control boxed" placeholder="Enter a description"></textarea>
                        ...
                        <div class="form-group {{ $errors->has('start_weight') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="start_weight" class="form-control boxed" placeholder="20">
                        ...
                        <div class="form-group {{ $errors->has('end_weight') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="end_weight" class="form-control boxed" placeholder="20">
                        ...
                        <div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="price" class="form-control boxed" placeholder="20 000">
