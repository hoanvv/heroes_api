...
@section('content')
<section id="disease-list">
    <div class="container">
        <h3>List Of Diseases <a href="/admin/disease/create">Add New</a></h3>
        <table id="list-categories" class="cell-border hover" cellspacing="0" width="100%">
            ...
            @foreach($list as $item)
                <tr>
                    <td>{{ ++$i }}</td>
                    <td>{{ $item->name }}</td>
                    <td><a href="/admin/vaccine/?disease_id={{ $item->id }}">Detail...</a></td>
                    <td>
                        <button type="button" class='btn btn-warning btn-xs btn-show-profile' data-id="{{$id = $item->id}}">
                            <i class="fa fa-list" aria-hidden="true"></i>
                        </button>
                        <a href="/admin/disease/{{$id}}/edit" class='btn btn-success btn-xs'>
    ...
    <!-- Modal -->
    <div id="disease-information" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    <div class="container">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label">Symptom</label>
                            <div class="col-sm-9">
                                <p class="disease-symptom"></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal -->
    <div id="delete-disease" class="modal fade" role="dialog">
